...
use primitives::{BeaversMul, BlindedSharedInputs};
...
type Triple<P> = primitives::Triple<<P as FixedPointParameters>::Field>;
    ...
    P::Field: PrimeField<BigInt = <<P::Field as PrimeField>::Params as FpParameters>::BigInt>,
{
        ...
        RNG: RngCore + CryptoRng,
    {
        ...
        for idx in 0..num_triples {
            server_triples.push(primitives::Triple {
                a: a[idx],
                b: b[idx],
                c: c[idx],
            });
    ...
    >(
        ...
        for idx in 0..num_triples {
            client_triples.push(primitives::Triple {
                a: a[idx],
                b: b[idx],
