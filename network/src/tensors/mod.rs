...
use primitives::{AdditiveShare, Share};
use ndarray::Array5;
use num_traits::Zero;
...
type Quadruple = (usize, usize, usize, usize, usize);

ndarray_impl!(Input, Array5, Quadruple);
ndarray_impl!(Kernel, Array5, Quadruple);
...
impl<I> Input<I> {
        ...
        I: Copy + Into<FixedPoint<P>>,
    {
        ...
        let result = Tensor::of_slice(&result).reshape(&[b as i64, c as i64, d as i64, h as i64, w as i64]);
        result
    }
        ...
        I: Copy + From<FixedPoint<P>>,
    {
        let shape = tensor
            .size5()
            .ok()
            .map(|(b, c, d, h, w)| (b as usize, c as usize, d as usize, h as usize, w as usize))?;
...
impl<I> Kernel<I> {
        ...
        I: Copy + Into<FixedPoint<P>>,
    {
        ...
        Tensor::of_slice(&result).reshape(&[c_out as i64, c_in as i64, d as i64, h as i64, w as i64])
    }
